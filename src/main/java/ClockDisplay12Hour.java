...
public class ClockDisplay12Hour
{
    ...
    public ClockDisplay12Hr(int hour, int minute, int parts){
        hours = new NumberDisplay(13);
        minutes = new NumberDisplay(60);
        part = new NumberDisplay(2);
        setTime(hour, minute, parts);
    }
    ...
    //The updateDisplay method should be called before finishing
    public void setTime(int hour, int minute, int parts){
        hours.setValue(hour);
